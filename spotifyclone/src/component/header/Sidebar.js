...
const Sidebar = () => {
  return (
    <div className="  h-full w-96 rounded-lg">
      <div className=" ml-5   p-6 bg-slate-900 rounded-xl" >
            <img
      ...
      <div className='ml-5 h-full  p-6 bg-slate-900 rounded-xl mt-2 flex flex-col '>
            <div>
                ...
                <div className=' bg-slate-700 rounded-xl mt-5'>
